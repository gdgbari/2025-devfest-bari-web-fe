...
export const LoginPage = () => {
    ...
    // Show loading while checking authentication OR if user is already logged in (to prevent form flash)
    if (!hasLoaded || (hasLoaded && user != null)) {
        const message = (hasLoaded && user != null) ? "Reindirizzamento" : "Verifica autenticazione"
        return <LoadingScreen message={message} showHeader={true} />
    }
