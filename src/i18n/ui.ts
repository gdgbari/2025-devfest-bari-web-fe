...
export const ui = {
    en: {
        ...
        'hero.thankYou': 'Thank you all! ❤️',
        'hero.photoAvailable': 'PHOTOS AVAILABLE',
        'hero.webApp': 'WEB APP',
        'hero.qrCode': 'QR CODE CHECK-IN',
        'footer.share': 'Share',
        ...
        'schedule.all': 'All',
        'schedule.scrollHint': 'Scroll horizontally to see all sessions',
        'schedule.live': 'LIVE',
    ...
    it: {
        ...
        'hero.thankYou': 'Grazie a tutti! ❤️',
        ...
        'sessions.toBeAnnounced': 'Da annunciare',
        ...
        'scheduling.noschedule': 'Programma non disponibile',
        'session.room': 'Aula',
        'team.description': `
        ...
        'location.description': `
            ...
            ${WebsiteConfig.EVENT_LOCATION_CITY} è una piccola città, e puoi 
        ...
        'schedule.showPastEvents': 'Mostra eventi passati',
        'schedule.allEventsEnded': 'Tutti gli eventi sono conclusi',
        'schedule.talks': 'Talk',
        'schedule.workshops': 'Workshop',
        'schedule.all': 'Tutti',
        'schedule.scrollHint': 'Scorri orizzontalmente per vedere tutte le sessioni',
        'schedule.live': 'IN DIRETTA',
        'schedule.upcoming': 'Prossimi',
        'schedule.past': 'Passati',
        'schedule.now': 'Ora',
        'schedule.today': 'Oggi',
        'schedule.tomorrow': 'Domani',
        'schedule.noEvents': 'Nessun evento programmato',
        'schedule.loading': 'Caricamento programma...',
